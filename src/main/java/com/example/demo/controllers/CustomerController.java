...
public class CustomerController {
	...
	public ResponseEntity<CustomerPojo> addCustomer(@RequestBody CustomerPojo b) {

		try {
			CustomerPojo cus = service.addCustomer(b);
			return new ResponseEntity<CustomerPojo>(cus, HttpStatus.CREATED);
		} catch (Exception e) {
			return new ResponseEntity<>(HttpStatus.NOT_FOUND);
		}
	}
